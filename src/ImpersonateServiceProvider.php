...
use codicastudio\Impersonate\Guard\SessionGuard;
use codicastudio\Impersonate\Middleware\ProtectFromImpersonation;
use codicastudio\Impersonate\Services\ImpersonateManager;

/**
 * Class ServiceProvider
 *
 * @package codicastudio\Impersonate
 */
class ImpersonateServiceProvider extends \Illuminate\Support\ServiceProvider
{
    /** @var string $configName */
    protected $configName = 'impersonate';
    ...
    protected function registerRoutesMacro()
    {
        ...
        $router->macro('impersonate', function () use ($router) {
            $router->get('/impersonate/take/{id}/{guardName?}',
                '\codicastudio\Impersonate\Controllers\ImpersonateController@take')->name('impersonate');
            $router->get('/impersonate/leave',
                '\codicastudio\Impersonate\Controllers\ImpersonateController@leave')->name('impersonate.leave');
        });
    }
