...
namespace codicastudio\Impersonate\Services;
...
use codicastudio\Impersonate\Events\LeaveImpersonation;
use codicastudio\Impersonate\Events\TakeImpersonation;
use codicastudio\Impersonate\Exceptions\InvalidUserProvider;
use codicastudio\Impersonate\Exceptions\MissingUserProvider;
...
class ImpersonateManager
{
    ...
    {
        return config('impersonate.session_guard_using');
    }

    public function getDefaultSessionGuard(): string
    {
        return config('impersonate.default_impersonator_guard');
    }
